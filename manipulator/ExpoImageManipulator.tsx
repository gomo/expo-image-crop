...
import { ExpoImageManipulatorProps } from '../';
...
class ExpoImageManipulator extends Component<ExpoImageManipulatorProps, State> {
  currentPos: {
    left: number,
    top: number;
  };
  ...
  async onConvertImageToEditableSize() {
    ...
    Image.getSize(rawUri, async (imgW, imgH) => {
      ...
      console.log({ imgW, imgH }, { convertedWidth, convertedheight });
